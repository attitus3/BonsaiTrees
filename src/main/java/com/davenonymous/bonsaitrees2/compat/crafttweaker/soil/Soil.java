...
public class Soil {
    ...
    public static String[] getTags(String id) {
        SoilInfo soil = ModObjects.soilRecipeHelper.getRecipe(CTCraftingTableManager.recipeManager, ResourceLocation.tryParse(id));
        if(soil == null) {
            return null;
        }
    ...
    public static String[] getAllIds () {
        return ModObjects.soilRecipeHelper.getRecipeStream(CTCraftingTableManager.recipeManager).map(s -> s.getId().toString()).toArray(String[]::new);
    }
}
